...
class _MainProfileState extends State<MainProfile> {
  ...
  void fetchData() async {
    var response = await networkHandling.get("profile/getProfileData");
    setState(() {
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          IconButton(
            ...
            onPressed: () {
              Navigator.of(context).push(MaterialPageRoute(builder: (context)=>CreateProfile(edit: true,)));
            },
            color: Colors.black,
          ),
        ],
